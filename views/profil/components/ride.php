...
<div class="row justify-content-between">
    ...
    <div class="col-5 text-start">
        <b><?= $params["rideInfos"]['d_end']  ?></b> <i class="bi bi-circle-fill"></i> <b><?= $params["rideInfos"]['start_city_name'] ?></b>
    </div>
    <div class="col-2 text-center">
        <?= $params["rideInfos"]['travel_time'] ?>
    </div>
    <div class="col-5 text-end">
        <b><?= $params["rideInfos"]['d_end'] ?></b> <i class="bi bi-circle"></i> <b><?= $params["rideInfos"]['end_city_name']  ?></b>
    </div>
</div>
<br>
<div class="row">
